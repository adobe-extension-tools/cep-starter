...
export class CSInterface {
   ...
   public hostEnvironment: any = JSON.parse((window as any).__adobe_cep__.getHostEnvironment())
   ...
   public getHostEnvironment(): any {
       this.hostEnvironment = JSON.parse((window as any).__adobe_cep__.getHostEnvironment())
       return this.hostEnvironment
   }

   /** Closes this extension. */
   public closeExtension() {
       (window as any).__adobe_cep__.closeExtension()
   }
    ...
    */
   public getSystemPath(pathType: string): string {
       let path = decodeURI((window as any).__adobe_cep__.getSystemPath(pathType))
    ...
    */
   public evalScript(script: string, callback: (executionResult: any) => void) {
       if (callback === null || callback === undefined) {
           callback = (result: any) => {}
       }
       (window as any).__adobe_cep__.evalScript(script, callback)
   }
    ...
    */
   public getHostCapabilities(): any {
       let hostCapabilities = JSON.parse((window as any).__adobe_cep__.getHostCapabilities() )
    ...
    */
   public dispatchEvent(event: CSEvent) {
       if (typeof event.data == 'object') {
           event.data = JSON.stringify(event.data)
       }

       (window as any).__adobe_cep__.dispatchEvent(event)
   }
    ...
    *         Default is null.
    */
   public addEventListener(type: string, listener: any, obj?: any) {
       (window as any).__adobe_cep__.addEventListener(type, listener, obj)
   }
    ...
    *          Default is null.
    */
   public removeEventListener(type: string, listener: any, obj?: any) {
       (window as any).__adobe_cep__.removeEventListener(type, listener, obj)
   }
    ...
    *
    */
   public requestOpenExtension(extensionId: string, params: string) {
       (window as any).__adobe_cep__.requestOpenExtension(extensionId, params)
   }
    ...
    */
   public getExtensions(extensionIds: string[]): any {
       let extensionIdsStr = JSON.stringify(extensionIds)
       let extensionsStr = (window as any).__adobe_cep__.getExtensions(extensionIdsStr)
    ...
    */
   public getNetworkPreferences(): any {
       let result = (window as any).__adobe_cep__.getNetworkPreferences()
    ...
    */
   public initResourceBundle(): any {
       let resourceBundle = JSON.parse((window as any).__adobe_cep__.initResourceBundle())
   ...
   public dumpInstallationInfo(): string {
       return (window as any).__adobe_cep__.dumpInstallationInfo()
   }
    ...
    *      </ul>\n
    */
   public openURLInDefaultBrowser(url: string): number {
   ...
   public getExtensionID(): string {
       return (window as any).__adobe_cep__.getExtensionId()
   }
   ...
   public getScaleFactor(): number {
       return (window as any).__adobe_cep__.getScaleFactor()
   }
    ...
    *
    */
   public setScaleFactorChangedHandler(handler: () => void) {
       (window as any).__adobe_cep__.setScaleFactorChangedHandler(handler)
   }
    ...
    *
    */
   public getCurrentApiVersion(): any {
       let apiVersion = JSON.parse((window as any).__adobe_cep__.getCurrentApiVersion())
       return apiVersion
   }
    ...
    *
    */
   public setPanelFlyoutMenu(menu: string) {
       if ('string' != typeof menu) {
           return
       }

       (window as any).__adobe_cep__.invokeSync('setPanelFlyoutMenu', menu)
   }
   ...
   public updatePanelMenuItem(menuItemLabel: string, enabled: boolean, checked: boolean): boolean {
       ...
       if (this.getHostCapabilities().EXTENDED_PANEL_MENU) {
           ...
           ret = (window as any).__adobe_cep__.invokeSync('updatePanelMenuItem', JSON.stringify(itemStatus))
       }
       return ret
   }
    ...
    * </Menu>
    */
   public setContextMenu(menu: string, callback: (clikedMenuId: string) => {}) {
       if ('string' != typeof menu) {
           return
       }

       (window as any).__adobe_cep__.invokeAsync('setContextMenu', menu, callback)
   }
    ...
    *
    */
   public setContextMenuByJSON(menu: string, callback: (clikedMenuId: string) => {}) {
       if ('string' != typeof menu) {
           return
       }

       (window as any).__adobe_cep__.invokeAsync('setContextMenuByJSON', menu, callback)
   }
    ...
    * @param checked        True to select the item, false to deselect it.
    */
   public updateContextMenuItem(menuItemID: string, enabled: boolean, checked: boolean) {
       let itemStatus = new ContextMenuItemStatus(menuItemID, enabled, checked)
       ret = (window as any).__adobe_cep__.invokeSync('updateContextMenuItem', JSON.stringify(itemStatus))
   }
   ...
   public isWindowVisible(): boolean {
       return (window as any).__adobe_cep__.invokeSync('isWindowVisible', '')
   }
    ...
    */
   public resizeContent(width: number, height: number) {
       (window as any).__adobe_cep__.resizeContent(width, height)
   }
    ...
    */
   public registerInvalidCertificateCallback(callback: () => void): any {
       return (window as any).__adobe_cep__.registerInvalidCertificateCallback(callback)
   }
    ...
    *
    */
   public registerKeyEventsInterest(keyEventsInterest: string): any {
       return (window as any).__adobe_cep__.registerKeyEventsInterest(keyEventsInterest)
   }
   ...
   public getWindowTitle(): string {
       return (window as any).__adobe_cep__.invokeSync('getWindowTitle', '')
   }
}
